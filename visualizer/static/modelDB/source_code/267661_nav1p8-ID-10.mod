...
PARAMETER {
	gbar = 0.013 : =220e-9/(100e-12*1e8) (S/cm2) : 220(nS)/100(um)^2
	ena=60 (mV)
	localtemp = 37
	...
	A_ah8 = 0.010152 (/ms) : A for alpha h  :  Fhf2KO model
	B_ah8 = 105 (mV)
	C_ah8 = 46.33 (mV)
	...
	A_bh8 = 0.822853 (/ms)   : A for beta h   : Fhf2KO model
	B_bh8 = -21.8 (mV)
	C_bh8 = -11.998 (mV)
}
...
FUNCTION rates(Vm (mV)) (/ms) {
	...
	tau_h = 0.8 / (alphah(Vm) + betah(Vm))   :  Fhf2KO
