...
Markov model for Cav2.3 channel function and Zn2+-induced modulation based on ionic and gating currents recorded from HEK-293 cells stably transfected with human Cav2.3+Ã3-subunits.
