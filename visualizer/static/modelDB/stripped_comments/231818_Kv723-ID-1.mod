...
PROCEDURE rates(v (mV)) {
  ...
  IF (gamma == 0.5) {
  	z1 = 2.8
		Vhalf1 = -49.8+Vshift 	
		tau01 = 20.7 (ms) *tau0mult	  
		Dtau1 = 176.1 (ms) *Dtaumult1	
		z2 = 8.9	              
		Vhalf2 = -55.5+Vshift 					
		tau02 = 149 (ms) *tau0mult   					
		Dtau2 = 1473 (ms) *Dtaumult2 	  			
	}	
	IF (gamma == 1) {
  	z1 = 3.6
		Vhalf1 = -25.3+Vshift		
		tau01 = 29.2 (ms) *tau0mult	  
		Dtau1 = 74.6 (ms) *Dtaumult1	
		z2 = 9.8	
		Vhalf2 = -44.7+Vshift 					
		tau02 = 155 (ms) *tau0mult   					
		Dtau2 = 549 (ms) *Dtaumult2  	  			
	}
