...
INITIAL {
    ...
    delta_U = alpha_RMru * sigh(RMr,theta_RMru,sigma_RMru)
}
...
DERIVATIVE state {
    ...
    RMBLK' = (RMBLK_inf - RMBLK)/tau_RMBLK  + alpha_cai_RMBLK * sigh(cai,theta_cai_RMBLK,sigma_cai_RMBLK)
