...
FUNCTION GAP1(GAPstart1 (ms), GAPstop1 (ms)) {
	...
	else if (t >= GAPstart1 && t <= GAPstop1) {GAP1 = 10}					
	else  {	GAP1 = 1}
}
FUNCTION unirand() {    
        unirand = scop_random()
