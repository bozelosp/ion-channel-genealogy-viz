...
PROCEDURE rates( v (mV) ) {
	...
	c2c1 = scale*DoubSig(vm,3.0,-35.0,10.0,16.0,-5.0,-10.0) 

	c2o1 = scale*DoubSig(vm,0,0,0,16.0, -10,-10.0)
	o1c2 = scale*DoubSig(vm,3.0,-40.0,10.0,16.0,-10,-10.0) 

	o1i1 = DISABLE*scale*DoubSig(vm,3.0,-41.0+hshift,12.0,16.0, -11.0+hshift,-12.0) 
	i1o1 = DISABLE*scale*DoubSig(vm,1.0e-5,-42.0+hshift,10.0,0,0,0) 

	i1c1 = DISABLE*scale*DoubSig(vm,0.55,-65.0,7.0,0,0,0)
	c1i1 = DISABLE*scale*DoubSig(vm,0,0,0,0.55,-65.0,-11.0)

	i1i2 = dist*scale*DoubSig(vm,0,0,0,2.2e-3,-90.0,-5.0) 
	i2i1 = scale*DoubSig(vm,1.7e-2,-90.0,15.0,0,0,0) 
	
	} else {

	c1c2 = 0.75*scale*DoubSig(vm,0,0,0,16.0,-8.0,-10.0)
	c2c1 = 0.25*scale*DoubSig(vm,2.0,-50.0,9.0,0.0,-8.0,-10.0) 

	c2o1 = 1*scale*DoubSig(vm,0,0,0,14.0, 0,-6.0)
	o1c2 = 1*scale*DoubSig(vm,4.0,-48.0,9.0,0,0,0) 

	o1i1 = 0.5*DISABLE*scale*DoubSig(vm,1.0,-42.0+hshift,12.0,5.0, 10.0+hshift,-12.0) 
	i1o1 = 0
	...
	i1i2 = 2.0*dist*DoubSig(vm,0,0,0,2.0e-2,-25.0,-5.0) 
	i2i1 = 2.0*DoubSig(vm,1.8e-3,-50.0,10.0,0,0,0) 
