NEURON {
    ...
    RANGE krPKAc_PKAr
    RANGE kfPKAc_PKAr
    RANGE kfPKA2cAMP_2cAMP
    RANGE krPKA2cAMP_2cAMP
    RANGE kactGolf
    RANGE kcatPDE4_cAMP
    RANGE kfPDE4_cAMP
    RANGE krPDE4_cAMP
    RANGE krPDE10_cAMP
    RANGE kcatPDE10c_cAMP
    RANGE kfPDE10_cAMP
    RANGE kfcAMP_PDE10
    RANGE krcAMP_PDE10
    RANGE kcatcAMP_PDE10
    RANGE kcatAC5GaolfGTP_ATP
    RANGE kicatAC5GaolfGTP_ATP
    RANGE kcatAC5_ATP
    RANGE kicatAC5_ATP
    RANGE kfAC5_ATP
    RANGE kGolfback
    RANGE kfAC5GaolfGTP_ATP
    RANGE kfD1R_Golf
    RANGE krD1R_Golf
    RANGE kfD1RDA_Golf
    RANGE krD1RDA_Golf
    RANGE krAC5X_ATP
    RANGE kfAC5XGaolfGTP
    RANGE krAC5XGaolfGTP
    RANGE krgso
    RANGE kfPDE10c_cAMP
    RANGE krPDE10c_cAMP
    RANGE kfD1R_DA
    ...
    RANGE krD1R_DA
    RANGE krD1RGolf_DA
    RANGE kfPP1_Target1p                    
    RANGE krPP1_Target1p                    
    RANGE kfPKAc_Target1                    
    RANGE krPKAc_Target1                    
    RANGE kcatPP1_Target1p                  
    RANGE kcatPKAc_Target1                  
    RANGE tscale                            
    RANGE Spine
    RANGE init_GaolfGDP
    RANGE init_Gbgolf
    RANGE init_GaolfGTP
    RANGE init_D1RDAGolf
    RANGE init_Golf
    RANGE init_D1RGolf
    RANGE init_D1RDA
    RANGE init_D1R
    ...
    RANGE init_DA
    RANGE init_AMP
    RANGE init_PDE4_cAMP
    RANGE init_PDE10c
    RANGE init_PDE10
    RANGE init_PDE10_cAMP
    RANGE init_PDE10c_cAMP
    RANGE init_ATP
    RANGE init_AC5GaolfGTP_ATP
    RANGE init_AC5_ATP
    RANGE init_PP1_Target1p                 
    RANGE init_Target1p                     
    RANGE init_PKAc_Target1                 
    RANGE init_Target1                      
    RANGE r_r_1               
    RANGE r_r_2               
    RANGE r_r_3               
