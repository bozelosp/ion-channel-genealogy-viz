NEURON {
	...
	RANGE ina, ik, ica
	RANGE gnabar, ena, m_inf, h_inf, tau_h, tau_m		 
	RANGE gkdrbar, ek, n_inf, tau_n, ikD                   
	RANGE gl, el, ilk                                      
	RANGE gcatbar, eca, p_inf, tau_p, q_inf, tau_q	       
	RANGE gcalbar, eca, c_inf, d1_inf, d2_inf, tau_c, tau_d1, tau_d2, icaT, icaL  
	RANGE gkabar, ek, a_inf, tau_a, b_inf, tau_b, ikA      
	RANGE gkcabar, ek, r_inf, ikAHP                        
      RANGE kca, vol, caGain                                 
}
